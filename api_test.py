...
routes = {
    ...
    "routes": [],
    "dashboard": [],
    "arrest_data": ["http://localhost:5000/arrest/data"],
    "arrest_agency_data": ["http://localhost:5000/arrest/data/agency"],
    "arrest_comment": ["http://localhost:5000/arrest/comment"],
    "arrest_date": ["http://localhost:5000/arrest/date_details?published=true&transport_type=bus", "http://localhost:5000/arrest/date_details?published=true"],
}
...
if __name__ == "__main__":
    ...
    # asyncio.run(main(post_url=post_url, json_data=arrest_comment))
    asyncio.run(main(get_url=routes["arrest_date"][1]))
